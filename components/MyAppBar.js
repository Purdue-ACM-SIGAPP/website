	...
	render() {
		return (
			<div>
				...
				<Drawer open={this.state.open} docked={false} useLayerForClickAway={true}
				        onRequestChange={this.switchOpen}>
					...
					<MenuItem href="https://drive.google.com/drive/folders/0ByBsXZAwFI0qSzY4NGFWeUZqeEU">Google
						Drive</MenuItem>
